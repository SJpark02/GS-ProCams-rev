...
# Projects the pattern onto a paraboloid (bowl-shaped) screen.
...
for setup_name in "${setup_names[@]}"; do
    for model_type in "${model_types[@]}"; do
        ...
        save_dir="${model_dir}/render_surface/curved_parabolic"
        mkdir -p "$save_dir"

        echo "============================================================"
        echo "Rendering setup='${setup_name}' surface='curved_parabolic'"
        echo "  -> ${save_dir}"
        echo "============================================================"
...
echo "Synthetic-surface (curved_parabolic) rendering done."
